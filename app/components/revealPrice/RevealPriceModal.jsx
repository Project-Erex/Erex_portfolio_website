...
export default function RevealPriceModal({handleClose, setIsLoggedIn}) {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 left-0 right-0 bottom-0 w-full h-full  bg-black/50 z-50 overflow-hidden flex justify-center   items-center">
      <motion.div
        initial={{scale: 0}}
        animate={{scale: 1}}
        transition={{duration: 0.3}}
        className="bg-white w-[400px] px-6 py-6  h-auto mt-24  rounded-md shadow-lg">
        ...
        <div className="w-full justify-center items-center flex">
          <Image width={0} height={0} alt="image" src={Reveal} className="w-40 h-auto " />
        </div>
