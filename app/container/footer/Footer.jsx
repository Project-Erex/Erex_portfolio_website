        ...
        <div className={`container ${styles.xPadding}`}>
          <div className="flex flex-wrap justify-between -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color text-secondary">
                  723143, Purulia, West Bengal India
                </p>
            ...
            <LinkGroup header="Our Services">
              <NavLink link="/#" label="Software Development" />
              <NavLink link="/#" label="Creative Design" />
              <NavLink link="/#" label="Digital Marketing" />
              <NavLink link="/#" label="ASO Expertise" />
              <NavLink link="/#" label="UI/UX Design" />
              <NavLink link="/#" label="AI/ML" />
            </LinkGroup>
