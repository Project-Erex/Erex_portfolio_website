...
export default function OurWebAndAppsPackages() {
  ...
  const priceAnimation = () => {
    ...
    const controls = animate(count, 14900, {duration: 5});
  ...
  return (
    <div className="flex items-center justify-center w-full h-full ">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 ">
        <div className="relative flex flex-col  rounded-[15px] w-full py-10 shadow-lg">
          ...
          <div className="relative w-full">
            ...
            <div className="px-5 py-6">
              ...
              <p className="text-[#4169E1] pt-2">{DigitalMarketing[6].text}</p>
            </div>
        ...
        <div className="relative  rounded-[15px] flex flex-col justify-between w-full py-10 shadow-lg">
          ...
          <div className="relative w-full ">
            ...
            <div className="px-5 py-6">
              ...
              <p className="text-[#A259FF] pt-2">{DigitalMarketing[7].text}</p>
            </div>
            {/* ******************************** */}
            <div className="flex flex-col gap-3 px-5 rounded-b-[15px] pb-7 ">
              <div className="flex flex-col items-start gap-3 ">
        ...
        <div className="relative flex flex-col rounded-[15px] justify-between w-full py-10 shadow-lg h-[620px] xl:h-full">
