  ...
  return (
    <div
      ...
      <div className="flex flex-col items-start justify-start w-full h-full gap-4 px-5 py-7 md:gap-5 md:py-6 md:px-4 lg:gap-5 xl:gap-6 lg:px-4 xl:px-6 lg:py-6 xl:py-8">
        <div className="relative flex items-center justify-start w-full h-auto ">
          <Image src={icon} alt={title} className="z-10 object-contain w-12 h-12 " />
          {/* <Image
            src={whiteIcon}
            alt={title}
            className="z-10 hidden object-contain w-12 h-12 transition-all duration-500 group-hover:flex"
          /> */}
        ...
        {/* <div className="w-full h-[25%] flex justify-start items-end ">
          <button className="w-10 h-10 transition-all duration-500 md:w-12 md:h-12 bg-lightGray group-hover:bg-opacity-10">
            <Image
              src={Arrow}
              alt="Arrow"
