  ...
  return (
    <section
      ...
      <div className="w-full max-w-screen-2xl">
        <div
          className={` ${styles.yPadding}  ${styles.xMargin} px-1  2xl:border-b-4  lg:px-6  xl:px-10  md:border-x-2 border-watermark  h-full  relative  bg-backgroundGray `}>
          <Heading
            text={"Testimonials"}
          ...
          <div className="z-30 flex items-center justify-center w-full   overflow-hidden  ">
            {/* <Slick /> */}
            <div className="  flex flex-col antialiased bg-background items-center justify-center relative overflow-hidden">
